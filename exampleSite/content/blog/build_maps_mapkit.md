...
Keep in mind that in order to use the location functions, we must first ask the user for permission. To do this, we add in the Info.plist file, a series of parameters (as I also showed to [use notifications](https://appcodify.com/articles/how-to-test-push-notifications-in-xcode-11-4-simulator/)):
